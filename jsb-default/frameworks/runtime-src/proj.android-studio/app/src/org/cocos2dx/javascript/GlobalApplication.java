...
public class GlobalApplication extends Application{
    public static int isNetWorkGlobal = 0;
...
//        String environment = AdjustConfig.ENVIRONMENT_SANDBOX;
        ...
        config.setOnAttributionChangedListener(new OnAttributionChangedListener() {
            ...
            public void onAttributionChanged(AdjustAttribution attribution) {
                ...
                Log.d("adjust", "==============attribution==================" + attribution.network);
                if (attribution.network.equals("Organic")) {
                    app.isNetWorkGlobal = 2;
                    Log.d("adjust", "==========jump====reportInstall2==================");
                    AppActivity.reportInstall2("0");
                } else {
                    app.isNetWorkGlobal = 1;
                }
                Log.d("adjust", "==============isNetWorkGlobal==================" + isNetWorkGlobal);
            }
        });
